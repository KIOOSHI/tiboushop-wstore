...
const ProductList = () => {
  ...
  return (
    <div className="container ml-10 mr-5 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="md:w-3/4 p-3">
          ...
          <div className="p-3">
            ...
            <button
              ...
              className="py-4 px-10 mt-5 border border-white rounded-lg text-lg font-bold bg-purple-500 hover:bg-purple-900"
            >
              Submit
            </button>
          </div>
